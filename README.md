...
**Top toolbar** — fixed to the top of the editor.

![Top toolbar](docs/images/top-toolbar.png)

**Selection toolbar** — floats next to selected text.

![Selection toolbar](docs/images/selection-toolbar.png)

Everything is configurable in **Settings → (unofficial) Editing Toolbar**:

**Appearance**

![Appearance settings](docs/images/settings-appearance.png)

**Toolbar Commands** — pick which commands show up, and in what order, for each toolbar.
