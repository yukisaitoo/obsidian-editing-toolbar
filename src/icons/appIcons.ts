...
// Call only after addIcons(), which registers the plugin's own icons. Legacy ids
// that would display under the same name as a "lucide-" one are dropped, so the
// picker shows no visual duplicates.
